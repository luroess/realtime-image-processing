...
begin
  ...
  begin
    ...
    v_gx := (to_integer(s_p3_u) + (2 * to_integer(s_p6_u)) + to_integer(s_p9_u)) - (to_integer(s_p1_u) + (2 * to_integer(s_p4_u)) + to_integer(s_p7_u));
    v_gy := (to_integer(s_p1_u) + (2 * to_integer(s_p2_u)) + to_integer(s_p3_u)) - (to_integer(s_p7_u) + (2 * to_integer(s_p8_u)) + to_integer(s_p9_u));
