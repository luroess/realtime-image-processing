...
begin
  ...
  U_AxiEdgeOverlay: entity work.AXI_EdgeOverlay
    ...
    port map (
      ...
      s_axis_video_edges_tvalid  => s_sobel_tvalid,
      s_axis_video_edges_tready  => open,
      s_axis_video_edges_tdata   => s_sobel_tdata,
      s_axis_video_edges_tuser   => s_sobel_tuser,
      s_axis_video_edges_tlast   => s_sobel_tlast,
