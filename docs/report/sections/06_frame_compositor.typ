...
For a comprehensive overview of frame-compositor-related tests, see #blink(<sec-frame-comp-verification>)[Verification: Frame-Compositor-related tests] in the appendix.
